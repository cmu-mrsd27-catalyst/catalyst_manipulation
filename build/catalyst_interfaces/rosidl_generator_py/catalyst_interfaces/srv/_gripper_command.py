...
class Metaclass_GripperCommand_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('catalyst_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GripperCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'catalyst_interfaces.srv.GripperCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from catalyst_interfaces.srv import _gripper_command
...
class GripperCommand(metaclass=Metaclass_GripperCommand):
    from catalyst_interfaces.srv._gripper_command import GripperCommand_Request as Request
    from catalyst_interfaces.srv._gripper_command import GripperCommand_Response as Response
