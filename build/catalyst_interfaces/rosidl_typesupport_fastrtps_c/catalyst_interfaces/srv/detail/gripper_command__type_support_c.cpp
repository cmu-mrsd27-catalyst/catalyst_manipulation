...
#include "catalyst_interfaces/srv/detail/gripper_command__rosidl_typesupport_fastrtps_c.h"
...
#include "catalyst_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _GripperCommand_Request__ros_msg_type = catalyst_interfaces__srv__GripperCommand_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catalyst_interfaces
size_t get_serialized_size_catalyst_interfaces__srv__GripperCommand_Request(
  const void * untyped_ros_message,
...
static uint32_t _GripperCommand_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_catalyst_interfaces__srv__GripperCommand_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catalyst_interfaces
size_t max_serialized_size_catalyst_interfaces__srv__GripperCommand_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = catalyst_interfaces__srv__GripperCommand_Request;
    is_plain =
      (
...
static size_t _GripperCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_catalyst_interfaces__srv__GripperCommand_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catalyst_interfaces, srv, GripperCommand_Request)() {
...
using _GripperCommand_Response__ros_msg_type = catalyst_interfaces__srv__GripperCommand_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catalyst_interfaces
size_t get_serialized_size_catalyst_interfaces__srv__GripperCommand_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_Response__ros_msg_type * ros_message = static_cast<const _GripperCommand_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_catalyst_interfaces__srv__GripperCommand_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catalyst_interfaces
size_t max_serialized_size_catalyst_interfaces__srv__GripperCommand_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = catalyst_interfaces__srv__GripperCommand_Response;
    is_plain =
      (
...
static size_t _GripperCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_catalyst_interfaces__srv__GripperCommand_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catalyst_interfaces, srv, GripperCommand_Response)() {
...
// already included above
// #include "catalyst_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "catalyst_interfaces/srv/gripper_command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catalyst_interfaces, srv, GripperCommand)() {
