...
Loads the composed URDF (xArm-6 + wellplate gripper) and opens RViz
with joint_state_publisher_gui so you can verify the model.

Usage:
  ros2 launch lab_auto_description display.launch.py
  ros2 launch lab_auto_description display.launch.py use_gui:=false
"""
